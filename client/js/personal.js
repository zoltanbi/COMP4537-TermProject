document.addEventListener('DOMContentLoaded', function() {
    fetch('https://zoltanbi.com/termproject/getallpersonal')
...
addBtn.onclick = function () {
    ...
    fetch('https://zoltanbi.com/termproject/insertpersonal', {
        headers: {
...
function deleteTableRow(id) {
    fetch('https://zoltanbi.com/termproject/deletepersonal/' + id, {
        method: 'DELETE'
    })
        .then(response => response.json())
        .then(data => {
...
updateBtn.onclick = function() {
    ...
    fetch('https://zoltanbi.com/termproject/updatepersonal/', {
        method: 'PATCH',
        headers: {
            'Content-type' : 'application/json'
        },
